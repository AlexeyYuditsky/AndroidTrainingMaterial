...
class UsersAdapter(
    ...
    override fun onClick(v: View) {
        ...
        if (v.id == R.id.starImageView) listener.onToggleFavoriteFlag(user)
        if (v.id == R.id.deleteImageView) listener.onUserDelete(user)
    }
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.binding.apply {
            ...
            userProgressBar.isVisible = user.inProgress
