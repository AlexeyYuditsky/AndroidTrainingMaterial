...
class MainActivity : BaseActivity() {
    ...
    override fun registerPlugins(manager: SideEffectPluginsManager) {
        ...
        manager.register(NavigatorPlugin(navigator))
        manager.register(ToastsPlugin())
        manager.register(ResourcesPlugin())
        manager.register(PermissionsPlugin())
        manager.register(DialogsPlugin())
        manager.register(IntentsPlugin())
    }

    private fun createNavigator(): StackFragmentNavigator {
        return StackFragmentNavigator(
